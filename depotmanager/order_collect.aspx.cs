...
public partial class depotmanager_order_collect : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!Page.IsPostBack)
        {
            ...
            RptBind("id>0 " + CombSqlTxt(this.product_category_id, this.note_no), "product_category_id desc");
    ...
    private void RptBind(string _strWhere, string _orderby)
    {
        ...
        this.rptList.DataSource = bll.GetListGroup(this.pageSize, this.page, _strWhere, _orderby, out this.totalCount);
        this.rptList.DataBind();

        //绑定页码
        txtPageNum.Text = this.pageSize.ToString();
        string pageUrl = Utils.CombUrlTxt("order_collect.aspx", "product_category_id={0}&note_no={1}&page={2}", this.product_category_id.ToString(), this.note_no, "__id__");
    ...
    {
        Response.Redirect(Utils.CombUrlTxt("order_collect.aspx", "product_category_id={0}&note_no={1}", this.product_category_id.ToString(), txtNote_no.Text));
    }

    //筛选商品类别
    protected void ddlproduct_category_id_SelectedIndexChanged(object sender, EventArgs e)
    {
        Response.Redirect(Utils.CombUrlTxt("order_collect.aspx", "product_category_id={0}&note_no={1}", this.ddlproduct_category_id.SelectedValue, txtNote_no.Text));
    ...
    {
        Response.Redirect(Utils.CombUrlTxt("order_collect_rep.aspx", "product_category_id={0}&note_no={1}", this.product_category_id.ToString(), txtNote_no.Text));
    }
