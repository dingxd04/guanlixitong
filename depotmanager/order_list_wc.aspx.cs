...
public partial class depotmanager_order_list_wc : System.Web.UI.Page
{
    ...
    {
        Response.Redirect(Utils.CombUrlTxt("order_list_wc.aspx", "depot_category_id={0}&depot_id={1}&status={2}&note_no={3}", this.depot_category_id.ToString(), this.depot_id.ToString(), this.status.ToString(), txtNote_no.Text));
    }
    ...
    protected void ddldepot_category_id_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Response.Redirect(Utils.CombUrlTxt("order_list_wc.aspx", "depot_category_id={0}&depot_id={1}&status={2}&note_no={3}", this.ddldepot_category_id.SelectedValue, this.depot_id.ToString(), this.status.ToString(), txtNote_no.Text));
    }

    //筛选下单商家
    protected void ddldepot_id_SelectedIndexChanged(object sender, EventArgs e)
    {
        Response.Redirect(Utils.CombUrlTxt("order_list_wc.aspx", "depot_category_id={0}&depot_id={1}&status={2}&note_no={3}", this.depot_category_id.ToString(), this.ddldepot_id.SelectedValue, this.status.ToString(), txtNote_no.Text));
    }
