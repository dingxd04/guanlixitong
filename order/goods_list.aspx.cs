...
public partial class order_goods_list : System.Web.UI.Page
{
    ...
    {
        Response.Redirect(Utils.CombUrlTxt("goods_list.aspx", "product_category_id={0}&note_no={1}", this.product_category_id.ToString(), txtNote_no.Text));
    }
    ...
    {
        Response.Redirect(Utils.CombUrlTxt("goods_list.aspx", "product_category_id={0}&note_no={1}", this.ddlproduct_category_id.SelectedValue, txtNote_no.Text));
    }
