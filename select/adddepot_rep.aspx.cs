...
public partial class select_adddepot_rep : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Response.AppendHeader("Content-Disposition", "attachment;filename=" + HttpUtility.UrlEncode("入库信息表"+DateTime.Now.ToString("d")+".xls", Encoding.UTF8).ToString());
