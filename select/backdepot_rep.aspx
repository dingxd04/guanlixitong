<%@ Page Language="C#" AutoEventWireup="true" CodeFile="backdepot_rep.aspx.cs" Inherits="select_backdepot_rep" %>
    ...
    <form id="form1" runat="server">
	  <table width="98%"  border="1" align="center" cellpadding="5" cellspacing="1" bgcolor="#CACACA">
          <tr bgcolor="#EAEAEA">
            ...
            <span style="font-size:18px;line-height: 25px;"><b>退货信息表</b></span></td>
          </tr>
                 <tr bgcolor="#FFFFFF"> 
	   ...
	   <td align="center"  bgcolor="#C0C0C0"><b>进货单价</b></td>
		 ...
		 <td align="center"  bgcolor="#C0C0C0"><b>退货数量</b></td>
        <td align="center"  bgcolor="#C0C0C0"><b>退货时间</b></td>
