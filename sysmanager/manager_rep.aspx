    ...
    <form id="form1" runat="server">
	  <table width="98%"  border="1" align="center" cellpadding="5" cellspacing="1" bgcolor="#CACACA">
          ...
          <tr bgcolor="#FFFFFF"> 
            ...
            <td align="center"  bgcolor="#C0C0C0"><b>所属商家</b></td>
        ...
        <ItemTemplate>
         <tr bgcolor="#FFFFFF" >
            ...
            <td align="left" style="vnd.ms-excel.numberformat:@" ><%# Eval("user_name")%></td>
             ...
             <td align="center"><%# Convert.ToInt32(Eval("depot_id")) == 0 ? "<font color=red>下级所有商家</font>" : new ps_depot().GetTitle(Convert.ToInt32(Eval("depot_id")))%></td>    
