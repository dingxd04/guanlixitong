...
public partial class sysmanager_product_category_edit : System.Web.UI.Page
{
    ...
    private bool DoAdd()
    {
        ...
        {
            mym.JscriptMsg(this.Page, "您输入的商品类别名称已经存在，请检查！", "", "Error");
            return false;
        }
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        if (action == "Edit") //修改
        {
            ...
            mym.JscriptMsg(this.Page, "修改商品类别信息成功！", Utils.CombUrlTxt("product_category_list.aspx", "page={0}", this.page.ToString()), "Success");
        }
        else //添加
        {
            if (!DoAdd())
            ...
            mym.JscriptMsg(this.Page, "添加商品类别信息成功！", "product_category_list.aspx", "Success");
        }
    }
